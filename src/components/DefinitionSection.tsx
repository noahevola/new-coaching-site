      ...
      <div className="mt-8 max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center mt-8">
          <button 
            ...
            className="bg-[#FFF041] text-black font-black text-sm sm:text-base md:text-lg lg:text-xl px-4 sm:px-6 md:px-8 py-3 md:py-4 rounded-lg hover:bg-[#E6D93A] transition-colors duration-200 flex items-center justify-center space-x-2 shadow-[0_0_60px_rgba(255,255,255,0.6)] w-fit"
          >
